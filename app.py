...
# All styling now handled by .streamlit/config.toml
...
def main():
    # Professional Header
    st.title("📊 ML Powered Portfolio Optimizer")
    st.caption("Institutional-Grade Portfolio Analytics & Risk Management")
    st.divider()
